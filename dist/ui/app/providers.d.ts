...
export declare const trpc: import("node_modules/@trpc/react-query/dist/createTRPCReact.js").CreateTRPCReactBase<import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
    ctx: {
