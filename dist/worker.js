...
import { registry, logger, createLogger, recordRun, startMetricsReporting, stopMetricsReporting, } from "./core/index.js";
        ...
        for (const file of files) {
            ...
            if (pipeline) {
                try {
                    ...
                    logger.error(`Failed to register pipeline ${pipeline.name}`, error);
                }
            }
        }
        return loadedCount;
 ...
 */
async function executeExistingRun(run, pipeline) {
